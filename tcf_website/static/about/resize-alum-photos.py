...
folders = ['tcf_website/static/about/team-pfps', 'tcf_website/static/about/alum-pfps']
...
for folder_name, images in [("alum-pfps", resizable_images_alum), ("team-pfps", resizable_images_team)]:
