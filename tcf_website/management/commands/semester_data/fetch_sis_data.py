...
def compile_course_data(course_number, semester):
    ...
    course_dictionary = {
        ...
        "Instructor2": ", ".join(instructor["name"] for instructor in meetings[1]["instructors"] if instructor["name"] != "-") if meetings[1] else "",
        ...
        "Instructor3": ", ".join(instructor["name"] for instructor in meetings[2]["instructors"] if instructor["name"] != "-") if meetings[2] else "",
        ...
        "Instructor4": ", ".join(instructor["name"] for instructor in meetings[3]["instructors"] if instructor["name"] != "-") if meetings[3] else "",
