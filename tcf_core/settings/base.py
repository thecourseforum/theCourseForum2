...
REVIEW_DRIVE_ID = env.str("REVIEW_DRIVE_ID") if "REVIEW_DRIVE_ID" in env else None
REVIEW_DRIVE_EMAIL = env.str("REVIEW_DRIVE_EMAIL") if "REVIEW_DRIVE_EMAIL" in env else None
REVIEW_DRIVE_PASSWORD = env.str("REVIEW_DRIVE_PASSWORD") if "REVIEW_DRIVE_PASSWORD" in env else None
