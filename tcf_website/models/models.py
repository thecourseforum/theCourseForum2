...
models.py
31 KB
Alex [VP-Infra Eng] — Today at 2:12 PM
dude posted the entire models file 💀💀
Oliver Song [Treasurer] — Today at 2:18 PM
...
﻿
AJ Nye [Secretary] — 01/21/2023 2:25 PM
...
AJ Nye [Secretary] — 01/19/2023 11:48 PM
...
AJ Nye [Secretary] — 09/26/2022 1:34 PM
...
AJ Nye [Secretary] — 09/25/2022 3:57 PM
...
Jenn — 02/18/2021 1:03 PM
@team Based on the when2meet, the Code Jam will be 3-9pm this Saturday! More specific details incoming in the #code-jam channel. Everyone's welcome to come out and brainstorm/work on project proposals for Sunday 🙂 
tCF Announcements
BOT
 — 02/17/2021 7:21 PM
@team:
...
also pls react 📣 if you prefer discord announcements or 📨 if we should keep doing emails instead
# pylint: disable=missing-class-docstring, wildcard-import, fixme
