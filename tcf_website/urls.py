...
urlpatterns = [
    ...
    path("reviews/reply/<int:reply_id>/upvote/", views.review.upvote_reply, name="upvote_reply"),
    path("reviews/reply/<int:reply_id>/downvote/", views.review.downvote_reply, name="downvote_reply"),
    path("reviews/reply/<int:reply_id>/delete/", views.review.delete_reply, name="delete_reply"),
