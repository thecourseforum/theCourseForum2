...
urlpatterns = [
    ...
    path("course/<str:mnemonic>/<int:course_number>/", views.course_view, name="course"),
    path("instructor/<int:instructor_id>/", views.instructor_view, name="instructor"),
    ...
    path(
        "schedule/duplicate/<int:schedule_id>/", views.duplicate_schedule, name="duplicate_schedule"
    ),
