import { sortByNumber, sortByRating, sortByDifficulty, sortByGpa, sortByRecency } from "./sortClasses.js";
...
if ($("#recency-sort-btn").length) {
    ...
    document.getElementById("recency-sort-btn").addEventListener("click", (event) => sortByRecency(event, false), false);
    // Binds single sort function
    document.getElementById("show-btn").addEventListener("click", (event) => sortByRecency(event, true), false);
}
