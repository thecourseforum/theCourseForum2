...
class CalendarOverviewTests(TestCase):
    ...
    def test_events_sorted_by_date(self, mock_get_events):
        ...
        mock_events = [
            {"eventName": "Event C", "organizationName": "Org C", "uri": "c", "startDateTimeUtc": "2025-01-03T10:00:00Z"},
            {"eventName": "Event A", "organizationName": "Org A", "uri": "a", "startDateTimeUtc": "2025-01-01T10:00:00Z"},
            {"eventName": "Event B", "organizationName": "Org B", "uri": "b", "startDateTimeUtc": "2025-01-02T10:00:00Z"},
        ]
