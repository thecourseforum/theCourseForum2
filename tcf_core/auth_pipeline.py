...
# Adapted from and replaces social_core.pipeline.mail.mail_validation
@partial
def mail_validation(backend, details, is_new=False, *args, **kwargs):
    ...
    if requires_validation and send_validation:
        ...
        if "verification_code" in data:
            ...
            # Disable the function which delete the partial token
            def no_op(*args, **kwargs):
                pass
            backend.strategy.storage.partial.destroy = no_op
